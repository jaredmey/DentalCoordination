        ...
        <nav class="navbar navbar-inverse">
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
              <li class="active"><a href="index.html">JEM Dental</a></li>
              <li><a href="#">Office Hours</a></li>
              <li><a href="#">About Us</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
              <li><a href="files/Usermanual.pdf"><span class="glyphicon glyphicon-user"></span>User Manual</a></li>
              <li><a href="login.html"><span class="glyphicon glyphicon-log-in"></span>Logout</a></li>
            </ul>
          </div>
        </nav>
        <div id="AdminPage" onclick="document.location.href = 'admin.html';" class="btn btn-warning">Admin page</div>
